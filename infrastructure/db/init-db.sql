...
BEGIN
    IF NOT EXISTS (
        ...
        CREATE TYPE auth.roleenum AS ENUM ('super_admin', 'clinic_admin', 'doctor', 'patient', 'admin', 'staff');
    END IF;

    ALTER TYPE auth.roleenum ADD VALUE IF NOT EXISTS 'super_admin';
    ALTER TYPE auth.roleenum ADD VALUE IF NOT EXISTS 'clinic_admin';
...
VALUES
    ('11111111-1111-4111-8111-111111111111', 'seed.admin@medstream.lk', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36ZKPPuBPpqA6E2dVCPf2K2', 'super_admin', TRUE, TRUE),
    ...
    ('66666666-6666-4666-8666-666666666666', 'clinic.admin@medstream.lk', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36ZKPPuBPpqA6E2dVCPf2K2', 'clinic_admin', TRUE, TRUE),
    ('77777777-7777-4777-8777-777777777777', 'clinic.staff@medstream.lk', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36ZKPPuBPpqA6E2dVCPf2K2', 'clinic_admin', TRUE, TRUE)
...
-- Migrate legacy roles to the new role model for compatibility.
UPDATE auth.users
SET role = 'super_admin'::auth.roleenum
WHERE role = 'admin'::auth.roleenum;

UPDATE auth.users
SET role = 'clinic_admin'::auth.roleenum
WHERE role = 'staff'::auth.roleenum;