"""Symptom-to-doctor recommendation logic for ai-service."""
...
from app.services.doctor_client import get_doctor_profile, search_doctors
...
def _extract_specialties_from_text(text: str) -> list[str]:
    ...
    return [
        value
        for value in values
        if isinstance(value, str) and value in SPECIALTY_KEYWORDS
    ][:MAX_SPECIALTIES]
