...
def register_doctor_user(
    ...
    url = f"{settings.AUTH_SERVICE_URL}/internal/doctor"
...
def deactivate_doctor_user(user_id: str) -> None:
    url = f"{settings.AUTH_SERVICE_URL}/internal/doctor/{user_id}/deactivate"
